...
import 'package:he/objects/blocs/apkupdate/bloc/apk_bloc.dart' as _i19;
...
import 'package:he/service/objectbox_service.dart' as _i15;
import 'package:he/service/permit_fofi_service.dart' as _i16;
import 'package:he/service/rx_sharedpref_service.dart' as _i18;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i10.IApkRepository>(
        () => _i11.ApkRepository(gh<_i6.FirebaseFirestore>()));
    gh.lazySingleton<_i12.IDatabaseRepository>(() => _i13.DatabaseRepository(
    ...
    await gh.factoryAsync<_i16.PermitFoFiService>(
      () => appModule.getfolderfileService,
      preResolve: true,
    );
    gh.lazySingleton<_i17.RxSharedPreferences>(
        () => appModule.getrxsharedprefrence);
    await gh.factoryAsync<_i18.RxSharedPreferencesService>(
      () => appModule.getRxStorageService,
      preResolve: true,
    );
    gh.lazySingleton<String>(() => appModule.getexternaldownlodpath);
    gh.factory<_i19.ApkBloc>(
        () => _i19.ApkBloc(repository: gh<_i10.IApkRepository>()));
    return this;
  }
}
