        ...
        switch (state.status) {
          ...
          case ThemeLangStatus.changelocalesuccess:
            return ListView.builder(
              itemCount:_bloclocalepopupmenu
                  .themeLocaleIntRepository.getLocalsApi$.supportedLocales.length,
              itemBuilder: (BuildContext context, int index) {
                return LanguageListItem(language: _bloclocalepopupmenu
                    .themeLocaleIntRepository.getLocalsApi$.supportedLocales[index],currentLocale:state.themeandlocalestate.item2);
              },
            );
          default:
