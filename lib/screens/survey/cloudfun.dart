...
// import 'package:nl_health_app/screens/utilits/models/movie.dart';
//
...
//         .useFirestoreEmulator('192.168.0.26', 8080, sslEnabled: false);
//   }
...
// /// are type-safe.
// CollectionReference mwoga =
//     FirebaseFirestore.instance.collection('firestore-example-app');
// final moviesRef = mwoga.withConverter<Movie>(
...
//     // mwoga
//     List<String> geners = ['BAdult', 'BYoung', 'BYouth'];
//     return mwoga
//         .add({
//           'poster': 'Aken', // John Doe
//           'likes': 2, // Stokes and Sons
//           'title': 'Chairman',
//           'year': 2020,
//           'runtime': 'AEvening',
//           'rated': '1 Stars',
...
//       /** Update End**/
//       //Start A
//       var docSnapshot = await mwoga.doc(widget.reference.id).get();
//       Map<String, dynamic>? data = docSnapshot.data() as Map<String, dynamic>?;
//       int updatedLikes = data!['likes'] + 1;
//       mwoga.doc(widget.reference.id).update({'likes': updatedLikes});
//       // print("Papa ${data!['likes']}");
//       //End A
//       // Update with the real count once the transaction has completed.
//       setState(() => _likes = updatedLikes);
//     } catch (e, s) {
//       print(s);
