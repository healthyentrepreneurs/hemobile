  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<HenetworkBloc, HenetworkState>(
      listener: (context, state) {
        debugPrint('Phila ${state.gstatus} Then ${state.status} ${state.gconnectivityResult}');
        databasebloc.add(DatabaseFetched('arthur', state.gstatus));
        debugPrint('Arthur Has Grown');
      },
      child: Scaffold(
