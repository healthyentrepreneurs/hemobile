...
class SettingsPage1 extends StatelessWidget {
  ...
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const SettingsPage1());
  }
            ...
            children: [
              _SingleSection(
                ...
                children: [
                  ...
                  const _CustomListTile(
                      title: "Security Status", icon: Icons.lock),
                ],
              ),
              _SingleSection(
                title: "Network",
              ...
              const _SingleSection(
                ...
                children: [
                  _CustomListTile(title: "Multiple Users", icon: Icons.group),
                  _CustomListTile(title: "Lock Screen", icon: Icons.lock),
                  _CustomListTile(title: "Display", icon: Icons.brightness_6),
                  _CustomListTile(
                      title: "Sound and Vibration", icon: Icons.volume_up),
                  _CustomListTile(title: "Themes", icon: Icons.brush)
                ],
              ),
            ],
          ),
