...
Future<void> sendSurveyFromLocal(List<dynamic> arguments) async {
...
void sendBookFromLocal(List<dynamic> arguments) {
...
Future<void> submitOnlineStat(dynamic instance, dynamic chapterId, int localId,
  ...
  try {
    ...
    dynamic value = await OpenApi().postStats(
...
//      home: Homepage(),
  ...
  void initState() {
    super.initState();
    PreferenceUtils.init().whenComplete(() {
      setState(() {});
    });
  }
}
